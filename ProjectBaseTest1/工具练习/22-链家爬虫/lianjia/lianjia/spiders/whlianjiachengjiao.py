...
class WhlianjiachengjiaoSpider(scrapy.Spider):
    ...
    def parse_item(self,response):
        for info_item in response.css('.listContent>li'):
            ...
            item['houseInfo']=info_item.css('div.houseInfo>span.houseIcon::text').extract_first()
            item['dealDate']=info_item.css('div.dealDate::text').extract_first()
            item['positionInfo']=info_item.css('div.positionInfo>span.positionIcon::text').extract_first()
